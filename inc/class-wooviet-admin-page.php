...
class WooViet_Admin_Page {
	...
	/**
	 * Install goship shipping method
	 * 
	 * If active goship install goship plugin with choose version
	 * if has update reinstall and replace goship plugin old version
	 *
	 * @param string $state (yes/no)  
	 * @param string $version (optional) goship version see full in https://github.com/KingDarkness/woo-goship/releases 
	 * @param string $update (optional) (yes/no) 
	 *
	 * @return void 
	 */
	...
	public function admin_page_html() {
        ...
        <a href="<?php echo admin_url('admin.php?page=wc-settings&tab=shipping&section=woo_goship') ?>"> <?php _e('Setting', 'woo-viet') ?> </a>
                        ...
                        <td>
                            ...
                            <input name="settings[use_goship][enabled]" type="checkbox" id="use_goship" value="yes"
								<?php if ('yes' == $settings['use_goship']['enabled']) {
            echo 'checked="checked"';
        } ?>>
